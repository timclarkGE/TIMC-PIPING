...
class AxisFrame:
    ...
    def activate_axis_btns(self):
        ...
        self.current_box.config(state="normal", bg="White")
        self.velocity_box.config(state="normal", bg="White")
...
class UpdateFeedback(threading.Thread):
    def __init__(self):
        ...
        self.write_cmd = ["PCMDPROG(" + TIMC.axis1.axisName + ")", "IFBK(" + TIMC.axis1.axisName + ")",
                          "VFBK(" + TIMC.axis1.axisName + ")", "PCMDPROG(" + TIMC.axis2.axisName + ")",
                          "IFBK(" + TIMC.axis2.axisName + ")", "VFBK(" + TIMC.axis2.axisName + ")"]
        ...
        while self._is_running:
            ...
            if TIMC.qFBK_read.qsize():
                ...
                if self.read_index == 0:
                    ...
                    cur = round(float(data), 2)
                    TIMC.axis1.current_box.config(text=("%.2f" % cur))
                    self.read_index += 1
                    ...
                    cur = round(float(data), 2)
                    TIMC.axis2.current_box.config(text=("%.2f" % cur))
                    self.read_index += 1
