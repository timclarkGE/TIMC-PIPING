...
class ScanFrame:
    def __init__(self, master, parameters1, parameters2, parameters3):
        self.master = master
        ...
        self.scan_setup = []
        for i in range(1, 6):
            self.scan_setup.append(parameters3[i].replace("\n", ""))  # Input Values from Setup File
        self.scan_config = []
        for i in range(6, 8):
            self.scan_config.append(parameters3[i].replace("\n", ""))  # Input Values from Setup File
        self.scan_state = 0
        self.paused = 0
...
def on_closing():
    ...
    if TIMC.online:
        ...
        try:
            ...
            print("Disable Axis 1")
        except:
            exception_flag = 1
        try:
            TIMC.axis2.disable_axis()   # Disable Axis 2
            print("Disable Axis 2")
        except:
            exception_flag = 2
        try:
            time.sleep(0.25)
