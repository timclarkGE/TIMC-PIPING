...
TIMC-PIPING Controller Software
Revision 0, Development Version 1
...
class Main:
    ...
    def start_status_and_feedback(self):
        ...
        self.process_log = UpdateLog(TIMC.qLog_write1, self.process_status.fault_array)
